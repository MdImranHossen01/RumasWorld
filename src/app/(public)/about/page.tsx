...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `About Us | ${brandName} - Premium Lifestyle & Fashion Brand`,
    description: `Discover the story of ${brandName} — bringing you the finest ethnic, traditional, and contemporary fashion for Men, Women, and Kids with authentic craftsmanship and timeless elegance.`,
  };
}
